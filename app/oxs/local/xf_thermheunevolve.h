/* FILE: xf_thermheunevolve.h                  -*-Mode: c++-*-
 *
 * Concrete evolver class, built on top of the Oxs_RungeKuttaEvolve
 * class, but including temperature dependent fluctuating field.
 *
 *  Xf_ThermEvolve is a variant of Oxs_RungeKuttaEvolve written by
 * Xuanyao (Kelvin) Fong, which adds support for non-zero temperatures.
 *
 * Xf_ThermEvolve version date: 2 March 2012
 * Requires OOMMF 1.2a4pre 20091216 or later.
 *
 */

#ifndef _XF_THERMHEUNEVOLVE
#define _XF_THERMHEUNEVOLVE
...
class Xf_ThermHeunEvolve:public Oxs_TimeEvolver {
private:
  ...
  **/
  ...
  Oxs_ScalarOutput<Xf_ThermHeunEvolve> max_dm_dt_output;
  Oxs_ScalarOutput<Xf_ThermHeunEvolve> dE_dt_output;
  Oxs_ScalarOutput<Xf_ThermHeunEvolve> delta_E_output;
  Oxs_ScalarOutput<Xf_ThermHeunEvolve> temperature_output;
  Oxs_VectorFieldOutput<Xf_ThermHeunEvolve> dm_dt_output;
  Oxs_VectorFieldOutput<Xf_ThermHeunEvolve> mxH_output;
...
#define RKStepFuncSig(NAME) \
  ...
  RKStepFuncSig((Xf_ThermHeunEvolve::* rkstep_ptr));
  ...
  Xf_ThermHeunEvolve(const Xf_ThermHeunEvolve&);
  Xf_ThermHeunEvolve& operator=(const Xf_ThermHeunEvolve&);

public:
  virtual const char* ClassName() const; // ClassName() is
  /// automatically generated by the OXS_EXT_REGISTER macro.
  virtual OC_BOOL Init();
  Xf_ThermHeunEvolve(const char* name,     // Child instance id
		       Oxs_Director* newdtr, // App director
		       const char* argstr);  // MIF input block parameters
  virtual ~Xf_ThermHeunEvolve();
